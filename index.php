<?php require('header.php'); ?>
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-8 text-center">
                ...
                <div><a href="contact.php" class="btn btn-primary btn-md">Hire Us</a></div>
              </div>
            </div>
              ...
              <div class="col-lg-5">
                <div class="h-100">
                  <div class="mb-5 d-flex align-items-center">
                    ...
                    <h2>Welcome To iBrainWare Software Services</h2>
                  </div>
    ...
    <a href="#" class="bg-primary py-5 d-block">
      ...
      <script src="js/typed.js"></script>
            ...
            strings: ["OnBase Workflow"," OnBase Administration"," OnBase Development"],
            typeSpeed: 80,
            backSpeed: 80,
            backDelay: 4000,
            startDelay: 1000,
